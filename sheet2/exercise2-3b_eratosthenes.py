...
This version, marks multiples of a prime P beginning at P**2.

It needs 104 markings to find the 25 primes in the interval [1, 100].
...
for i in range(2, n+1):
    ...
    if marked[i] == False:
        # Mark all multiples
        for k in range(i**2, n+1, i):    # Look here! This is the optimization!
            marked[k] = True
            markings += 1
